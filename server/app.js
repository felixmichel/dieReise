...
// FIXME: Uninstall npm modules (npm uninstall). Also remove folder "views", "public" and "bin" (including contents), remove commented code below
//
// // view engine setup
...
app.use(function(err, req, res, next) {
  res.status(err.status || 500);
  // FIXME: Following two lines should not be needed since we use CORS module
